...
class CollectionDetailActivity : BaseActivity() {
    ...
    private val collectionPageAdapterFactory by inject<CollectionPageAdapterFactory>()

    private val collectionPageViewModel by inject<CollectionPageViewModel>()
    private val viewHolderFactory by inject<ViewHolderFactory>()
